...
#'   Default: 1.
#' @param sex Integer vectors indicating the genders of the offspring to be
#'   created (recycled if less than `nch` elements).
...
#' @param new,old Vectors of the same length. ID labels in `old` are replaced by those in `new`.
#'
