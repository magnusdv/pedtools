...
## Accessing and modifying individual marker attributes
...
## Getting and setting marker attributes globally
Several functions in `pedtools` are indented for modifying many (or all) marker objects at the same time. Their purpose and typical use cases are summarised in the table below. The argument `x` always denotes a `ped` object.
```{r getset, echo = FALSE}
getters.df = rbind(
  c("`getAlleles(x)`", 
