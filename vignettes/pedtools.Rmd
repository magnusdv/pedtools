...
plot(trio, hatched = "fa", fill = c(mo="pink", girl = "lightblue"),
     col = c("green", "red", "blue"), lwd = 3:1, lty = 1:3)
```

And here is an example of how to put text annotation around the symbols:

```{r trio3, fig.dim = c(2.5,2), out.width = "45%"}
plot(trio, margin = c(1,4,1,1), textAnnot = list(
...
trio4 = singleton("fa") |> 
  ...
  relabel(old = "a1", new = "mo")
```

Note that `addDaughter()` automatically created the mother as "a1", so we needed to relabel her.  
